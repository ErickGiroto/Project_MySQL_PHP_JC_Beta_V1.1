...
if (isset($_GET['id']) && isset($_GET['status'])) {
    ...
    if ($pedido) {
        ...
        if ($produto_estoque) {
            ...
            if (($status == 'Iniciado' || $status == 'Finalizado') && $status_atual != 'Iniciado' && $status_atual != 'Finalizado') {
        ...
        <body>
            ...
            } elseif (($status == 'Não Iniciado' || $status == 'Cancelado') && ($status_atual == 'Iniciado' || $status_atual == 'Finalizado')) {
